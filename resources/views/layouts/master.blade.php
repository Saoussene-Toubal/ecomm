    ...
    <header class="blog-header pt-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
          <a class="blog-header-logo" style="color: #17a2b8 !important;" href="{{ route('products.index') }}">produits<img src="{{ asset('img/logo.png') }}" width="200" alt=""></a>
        </div>
...
<footer class="blog-footer">
  <p>
    <a href="https://github.com/ludoguenet/ecommerce-app-laravel-6">Suuzana</a> - 🛒 devloped with love and laravel
  </p>
  <p>
