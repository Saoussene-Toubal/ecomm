                                    ...
                                    <th scope="row" class="border-0">
                                        <div class="p-2">
                                            ...
                                            <div class="ml-3 d-inline-block align-middle">
                                                <h5 class="mb-0"> <a href="{{ route('product.show', ['slug' => $product->model->slug]) }}" class="text-dark d-inline-block align-middle">{{ $product->model->title }}</a></h5><span class="text-muted font-weight-normal font-italic d-block">Catégories: @foreach ($product->model->categories as $category)
            ...
            <div class="row p-4 bg-white rounded shadow-sm">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        ...
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Article</strong><strong>{{ getPrice(Cart::subtotal()) }}</strong></li>
                        @if (request()->session()->has('coupon'))
                        ...
                        <strong style="color:red">- {{ getPrice(request()->session()->get('coupon')['remise']) }}</strong></li>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Article</strong><strong>
                        ...
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Prix </strong><strong>
